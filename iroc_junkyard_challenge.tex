...
%% \caption{Oil Spill Mission Challenge: Robots with a single light
%%   sensor must collect and deposit simulated oil from the playing
%%   field. A line helps navigation in only one half of the playing
%%   field.}
%% \label{fig:oil-spill}
\end{center}
