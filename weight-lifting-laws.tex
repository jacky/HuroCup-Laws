...
\section*{Changes to the Rules of \HuroCup\ Weight Lifting for \thisyear}

The distance that the robot has to walk as been increased for the
small robots to 50cm and for the large robots to 100cm.
...
\item There are three lines marked on the playing field: (a) the start line,
 ...
 50cm for small robots and 100cm for large robots.
...
\item While at least one foot is touching the lifting line, the robot
  ...
  between the low and high position must be at least:
  \begin{itemize}
    \item 15cm for small robots,
    \item 45cm for large robots.
  \end{itemize}
...
\hline
17th Sept. 2011 & FIRA WorldCup 2010 & Beyond   & Nanyang Politechnic, Singapore &    80 \\
